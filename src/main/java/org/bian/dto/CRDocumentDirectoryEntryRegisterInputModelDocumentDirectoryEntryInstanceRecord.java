...
/**
 * CRDocumentDirectoryEntryRegisterInputModelDocumentDirectoryEntryInstanceRecord
 */
public class CRDocumentDirectoryEntryRegisterInputModelDocumentDirectoryEntryInstanceRecord   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Tracks any verification tasks performed against the document 
